        ...
        <div>
          ...
          <div className="space-y-3">
            <input
              ...
              className="w-full px-4 py-2 bg-gray-800 border-gray-800 text-white rounded-full border focus:outline-none"
            />
            <button
              style={{
              ...
              className={`w-full px-4 cursor-pointer py-2 text-white rounded-full transition`}
            >
              Track
            </button>
          </div>
